...
#include "tensorflow/lite/jinterc/kernels/register_jinterc.h"
...
const TfLiteRegistration* BuiltinJintercOpResolver::FindOp(
    tflite::BuiltinOperator op, int version) const {
  return MutableOpResolver::FindOp(op, version);
}

const TfLiteRegistration* BuiltinJintercOpResolver::FindOp(const char* op,
                                                       int version) const {
...
BuiltinJintercOpResolver::BuiltinJintercOpResolver() {
