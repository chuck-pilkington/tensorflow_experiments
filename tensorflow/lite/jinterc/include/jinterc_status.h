...
#ifndef TENSORFLOW_LITE_DELEGATES_JINTERC_COMMON_STATUS_H_
#define TENSORFLOW_LITE_DELEGATES_JINTERC_COMMON_STATUS_H_
...
#endif  // TENSORFLOW_LITE_DELEGATES_JINTERC_COMMON_STATUS_H_
